...
Java_fang_cybertron_MainActivity_Toast(JNIEnv *env, jclass obj, jobject context) {
    MakeToast(env, context, OBFUSCATE("Welcome To Cybertron"), Toast::LENGTH_LONG);
}
...
Java_fang_cybertron_modmenu_FloatingModMenuService_getFeatureList(JNIEnv *env, jobject activityObject) {
    ...
    const char *features[] = {
            OBFUSCATE("Category_LOBBY"),
            OBFUSCATE("1_Toggle_MapHack No Icon"), //Starts with 0
            OBFUSCATE("2_Toggle_Unlock All Emblems"),
			OBFUSCATE("3_Toggle_Unlock All Skins"),
			OBFUSCATE("Category_ESP"),
			OBFUSCATE("4_Toggle_Esp Player Line"),
			OBFUSCATE("5_Toggle_Esp Player Box"),
			OBFUSCATE("6_Toggle_Esp Player Distance"),
			OBFUSCATE("Category_OTHER"),
			OBFUSCATE("7_Toggle_MapHack Icon"),
			OBFUSCATE("8_Toggle_Visible In Grass"),
            OBFUSCATE("9_SeekBar_Drone View_0_20"), //Assigned numbers are not counted, so 1
            };
