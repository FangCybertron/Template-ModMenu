...
package fang.cybertron.modmenu;
...
public class FloatingModMenuService extends Service {
	...
	int TEXT_COLOR_3 = Color.parseColor(getInfo("TXT3_CL"));
    ...
    private void initFloating() {
		...
		patches.setBackgroundColor(CategoryBG);
        //**********  Hide/Kill button **********
    ...
    private View addSlider(final int featureNum, final String featureName, final int min, int max) {
        ...
        seekBar.setMax(max);
		seekBar.getThumb().setColorFilter(Color.parseColor("YELLOW"), PorterDuff.Mode.SRC_IN);
